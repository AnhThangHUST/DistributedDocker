...
---> and should make a virtual function with the option path
Hint: Flow is NewRunCommand --> runRun --> runContainer --> func1 -->func2(func1 and func2: You should figure out by yourself)
      Add Option in runOptions
*/
